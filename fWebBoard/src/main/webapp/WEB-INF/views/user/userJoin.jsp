  ...
  <table class='table2'>
    <tr> 
      ...
      <!-- id가 userId -->
        ...
        <!-- $('#idCheckResult').html(resultData); id가 idCheckResult인 애의 innerHTML로 넣기 -->
...
<!--  		// 유효성검사 -->
<!--  		// 사용자가 입력한 값이 우리 시스템에 적용할수있도록 잘 입력이 되어있는 검사하는 행위 -->
<!--  		// 가장 효율적인 언어, 가장 효율적인 시점 (포인트)가 존재할 뿐 잘못된것 없다 -->
...
<!--  		document.userinput.submit(); // action="userInsert.do" 가 실행 -->

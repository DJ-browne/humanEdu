...
//	public MemberController(MemberService boardService) {
//		this.memberService = boardService;
//	}
...
//	public String userLogin() {
//		return "userLogin"; // "/WEB-INF/views/" + ".jsp";
//	}
...
//		session.invalidate(); // 초기화 , 모든 세션을 제거하기때문에 주의
	...
	@ResponseBody // 화면 전환이 되지않고 비동기통신이 가능하도록 만들어주는 어노테이션
	public String idCheck(MemberVO vo, String userId) {
		
		System.out.println("===ID중복체크===");
		System.out.println(vo.getUserId()); // vo로 받아도되고
		System.out.println(userId); // 파라미터값으로 받아도됨

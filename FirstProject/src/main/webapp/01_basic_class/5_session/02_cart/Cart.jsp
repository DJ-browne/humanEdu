...
<%
	...
	id = request.getParameter("id"); // value 담긴 값 / 1020
	name = request.getParameter("name"); // value 담긴 값 / 삼성 TV CT 14R1
	price = Integer.parseInt(request.getParameter("price")); // value 담긴 값 / 147000
